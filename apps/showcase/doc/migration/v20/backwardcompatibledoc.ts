    ...
    template: `
        <app-docsectiontext>
            ...
            <p>
                ...
                source of truth. Prior to v20, PrimeNG has its own fork in default styles and for the design tokens <i>{{ '@' }}primeng/themes</i> package is required. With v20, PrimeNG receives the styles from <i>{{ '@' }}openng/optimus-ui-styles</i> under
                the hood and the design tokens as theme presets are loaded from <i>{{ '@' }}openng/optimus-ui-themes</i>.
            </p>
            <p>
            ...
            <p class="mt-4">
                All of these changes are backward compatible, <i>{{ '@' }}primeng/themes</i> use <i>{{ '@' }}openng/optimus-ui-themes</i> internally, and migration is easy as replacing the dependency <i>{{ '@' }}primeng/themes</i> with
                <i>{{ '@' }}openng/optimus-ui-themes</i> in your application.
            </p>
        </app-docsectiontext>
    `
})
