    ...
    template: `
        <app-docsectiontext>
            ...
            <p>
                ...
                source of truth. Prior to v20, PrimeNG has its own fork in default styles and for the design tokens <i>{{ '@' }}primeng/themes</i> package is required. With v20, PrimeNG receives the styles from
                <i>{{ '@' }}openng/optimus-ui-styles</i> under the hood and the design tokens as theme presets are loaded from <i>{{ '@' }}openng/optimus-ui-themes</i>.
            </p>
            <p>
